...
•	Suggests a simple meal plan
•	Calculates macro requirements (protein, carbs, fats)
...
Make sure the Python file and JSON file are in the same folder.
4. Run the Program
Use the command:
...
•	Test both veg and non-veg options.
